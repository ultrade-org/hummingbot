...
from hummingbot.strategy.ultrade_pure_market_making import UltradePureMarketMakingStrategy
from hummingbot.strategy.pure_market_making.moving_price_band import MovingPriceBand
from hummingbot.strategy.ultrade_pure_market_making.ultrade_pure_market_making_config_map import ultrade_pure_market_making_config_map as c_map
...
async def start(self):
    ...
    try:
        ...
        strategy_logging_options = UltradePureMarketMakingStrategy.OPTION_LOG_ALL
        self.strategy = UltradePureMarketMakingStrategy()
